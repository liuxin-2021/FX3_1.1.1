...
extern void AR0234_Write_Sensor1_Commit(uint16_t regAddr, uint16_t regData);
extern void AR0234_Write_Sensor2_Commit(uint16_t regAddr, uint16_t regData);
extern void AR0234_Write_SensorsSame_Commit(uint16_t regAddr, uint16_t regData);
extern void AR0234_Write_SensorsIndependent_Commit(uint16_t regAddr, uint16_t sensor1Data, uint16_t sensor2Data);
